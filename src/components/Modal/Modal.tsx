...
const Modal = ({
  ...
  return (
    <div {...props}>
      ...
      >
        <div 
          className={["relative p-4 w-full h-full md:h-auto", size].join(" ")}
        >
          {/* Modal content */}
...
// <!-- Top Left Modal -->
// <div id="top-left-modal" data-modal-placement="top-left" tabindex="-1" className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
...
//                     Top left modal
//                 </h3>
//                 <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="top-left-modal">
